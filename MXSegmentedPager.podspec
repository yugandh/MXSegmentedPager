...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => "https://github.com/yugandh/MXSegmentedPager.git", :tag => ":branch => 'master'"}
  ...
  s.dependency pod 'HMSegmentedControl', :git => "https://github.com/HeshamMegid/HMSegmentedControl.git", :tag => '":branch => 'master'"'
