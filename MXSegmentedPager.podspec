...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => "https://github.com/yugandh/MXSegmentedPager.git", :tag => s.version.to_s }
  ...
  s.dependency 'HMSegmentedControl', :git => 'https://github.com/yugandh/HMSegmentedControl'
